...
class RealAggregateSource(Source):
    def __init__(self, activations, target_appliance, seq_length, filename,
    ...
    """
    Everything below this line hasn't been re-written from
    SyntheticAggregateSource.
    """
